...
public class TxtParserHandler extends BaseMissionParser {
    ...
    private void parseMissionSection(String key, String value, ConcreteMissionBuilder builder) {
        switch (key) {
            ...
            case "outcome"   -> builder.buildOutcome(Outcome.valueOf(value.toUpperCase()));
    ...
    private void parseCurseSection(String key, String value, Map<String, Object> currentObjects) {
        ...
        switch (key) {
            ...
            case "threatLevel" -> {
                try { curse.setThreatLevel(ThreatLevel.valueOf(value.toUpperCase())); }
    ...
    private void parseSorcererSection(String key, String value, Map<String, Object> currentObjects) {
        ...
        switch (key) {
            ...
            case "rank" -> {
                try { s.setRank(Rank.valueOf(value.toUpperCase())); }
                catch (Exception ignored) {}
            }
        }
    }
    ...
    private void parseTechniqueSection(String key, String value, Map<String, Object> currentObjects) {
        ...
        switch (key) {
            ...
            case "type"  -> {
                try { t.setType(TechniqueType.valueOf(value.toUpperCase())); }
                catch (Exception ignored) {}
            }
            case "owner" -> t.setOwner(value);
            case "damage"-> t.setDamage(Long.valueOf(value));
        }
    }
    ...
    private void parseEnvironmentConditionsSection(String key, String value, Map<String, Object> currentObjects) {
        ...
        switch (key) {
            ...
            case "visibility"          -> env.setVisibility(Visibility.valueOf(value));
            case "cursedEnergyDensity" -> {
                try { env.setCursedEnergyDensity(Double.valueOf(value)); }
